...
void Sandbox2D::OnUpdate(Mortify::Timestep ts)
{
...

	{
		...
		Mortify::Renderer2D::DrawQuad({{-1.0f, 0.0f, 0.0f }, { 0.8f, 0.8f }, 0.0f,  {0.8f, 0.2f, 0.3f, 1.0f}});
		Mortify::Renderer2D::DrawQuad({{0.5f, -0.5f, 0.0f }, { 0.5f, 0.75f }, 0.0f,  {0.2f, 0.3f, 0.8f, 1.0f}});
		Mortify::Renderer2D::DrawQuad({{ 0.0f, 0.0f, -0.1f }, { 10.0f, 10.0f }, 0.0f,  glm::vec4(1.0f), m_CheckerboardTexture, 10.0f});
